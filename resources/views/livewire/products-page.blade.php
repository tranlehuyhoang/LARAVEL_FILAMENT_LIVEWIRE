            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="status-in-stock" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" id="status-in-stock" class="w-4 h-4 mr-2">
                                    <span class="text-lg dark:text-gray-400">In Stock</span>
                                </label>
                            </li>
                            <li class="mb-4">
                                <label for="status-on-sale" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" id="status-on-sale" class="w-4 h-4 mr-2">
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    <div class="relative bg-gray-200">
                                        <a wire:navigate href="{{ url('/products/' . $product->slug) }}" class="">
                                            <img src="{{ Storage::url(is_array($product->images) ? $product->images[0] : $product->images) }}"
                                    ...
                                    <div class="p-3">
                                        ...
                                        <p class="text-lg">
                                            <span
                                                class="text-green-600 dark:text-green-600">{{ number_format($product->price) }} vnđ</span>
                                        </p>
                                    </div>
