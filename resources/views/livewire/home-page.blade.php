        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                @foreach($categories as $category)
                    <div class='title-d form-group'>{{ $category->name }}</div>
                    <div class="row">
                        @foreach($category->products as $product)
                            <div class="col-md-3 col-sm-4 col-50">
                                <div class="product-item mg-30">
                                    <a href="{{ url('/san-pham/' . $category->slug . '/' . $product->slug) }}"  class="img-products">
                                    ...
                                    <a href="{{ url('/san-pham/' . $category->slug . '/' . $product->slug) }}" class="title-products">
                                        {{ $product->name }}
                                    </a>
