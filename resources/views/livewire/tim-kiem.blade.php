        ...
        <div class="row">
            ...
            <div class="col-md-9" id="secondDiv">
                ...
                <div class="alert alert-info">
                    Hiện đang có <b>{{$totalResults}}</b> sản phẩm {{$searchText}}
                </div>
                <div class="row">
